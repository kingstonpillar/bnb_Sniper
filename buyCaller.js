...
const liqLockedPass  = liqLocked?.pass === true || liqLocked === true; // tolerate boolean or object
...
if (!token.staticChecked) {
  ...
  return;
      ...
      // Entry scan immediately after static pass (FULL OBJECT MODE)
      ...
      // Reserve tracking: scan.reserves.wbnb (NOT scan.bnbReserve)
