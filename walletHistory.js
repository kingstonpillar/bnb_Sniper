// file: walletHistory.js (or wherever you keep walletRate)
// NOTE: This is a static risk screen only.
...
// Normalize imported constants too (do not trust casing from env.js)
...
async function getWbnbPairForToken(tokenAddress) {
  ...
  try {
    ...
    const pp = norm(pair);
    if (pp && pp !== ethers.ZeroAddress.toLowerCase()) return pp;
  } catch {}
