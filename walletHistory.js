...
// ----------------------------------------------------------------------
// STRICT NEW-LAUNCH VALIDATION
// Accept WBNB or the native BNB placeholder
// ----------------------------------------------------------------------
} else {
  const WBNB = "0xBB4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c";
  const NATIVE_BNB_PLACEHOLDER = "0x0000000000000000000000000000000000000000";

  if (
    ![token0, token1].includes(WBNB) &&
    ![token0, token1].includes(NATIVE_BNB_PLACEHOLDER)
  ) {
    return {
      ok: false,
      reason: "NO_WBNB_PAIR"
