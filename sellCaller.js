...
// ---------------- MONITOR LOOP ----------------
// NOTE: sellCaller() must already exist above this section in your file.
// It should do: read positions + checkPosition(pos) etc.
...
// start looping sellCaller (interval lives inside the module)
export function startSellCaller() {
  if (sellTimer) return;
  ...
  // then loop at interval (no overlap)
...
export async function stopSellCaller() {
  ...
  // wait for any active tick to finish
